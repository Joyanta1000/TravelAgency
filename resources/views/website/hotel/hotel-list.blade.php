                ...
                <div class="row">
                    <div class="col-sm-4 col-md-3">
                        ...
                        <div class="toggle-container filters-container">
                            ...
                            <div class="panel style1 arrow-right">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" href="#accomodation-type-filter"
                                        class="collapsed">Accomodation Type</a>
                                </h4>
                                <div id="accomodation-type-filter" class="panel-collapse collapse">
                                    <div class="panel-content">
                                        <ul class="check-square filters-option">
                                            ...
                                            <li class="active"><a href="#">Bed &amp;
                                                    Breakfast<small>(222)</small></a></li>
                                ...
                                <div id="amenities-filter" class="panel-collapse collapse">
                                    <div class="panel-content">
                                        <ul class="check-square filters-option">
                                            ...
                                            <li class="active"><a href="#">air conditioning<small>(127)</small></a>
                                            </li>
                            ...
                            <div class="panel style1 arrow-right">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" href="#language-filter" class="collapsed">Host
                                        Language</a>
                                </h4>
                        ...
                        <div class="sort-by-section clearfix">
                            ...
                            <ul class="sort-bar clearfix block-sm">
                                ...
                                <li class="sort-by-rating active"><a class="sort-by-container"
                                        href="#"><span>rating</span></a></li>
                                <li class="sort-by-popularity"><a class="sort-by-container"
                                        href="#"><span>popularity</span></a></li>
                            </ul>
                            ...
                            @foreach ($hotels as $hotel)
                                <article class="box">
                                    <figure class="col-sm-5 col-md-4">
                                        <a title="" href="ajax/slideshow-popup.html" class="hover-effect popup-gallery"><img
                                                width="270" height="160" alt="" src="http://placehold.it/270x160"></a>
                                    </figure>
                                    <div class="details col-sm-7 col-md-8">
                                        <div>
                                            <div>
                                                <h4 class="box-title">{{ $hotel->name }}<small><i
                                                            class="soap-icon-departure yellow-color"></i> Bastille, Paris
                                                        france</small></h4>
                                                <div class="amenities">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <a class="button btn-small full-width text-center" title=""
                                                    href="{{ route('hotel-detailed', $hotel->id) }}}">SELECT</a>
                                            </div>
                                        </div>
                                    </div>
                                </article>
