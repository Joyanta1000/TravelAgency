...
<section id="content">
    <div class="container">
        <div class="row">
            <!-- @if (flash()->message)
            <div class="{{ flash()->class }}" style="height: 50px; text-align: center;">
                {{ flash()->message }} -->
        </div>
            ...
            <div id="hotel-features" class="tab-container">
                <ul class="tabs">
                    ...
                    @auth<li id="checkToReview" class="" onclick="active(this)">
                        <a href="#hotel-write-review" type="button" data-toggle="modal" data-target="#exampleModal">Write a Review</a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="hotel-availability">
                        <div class="update-search clearfix">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <button data-animation-duration="1" data-animation-type="bounce" class="full-width icon-check animated" type="submit">SEARCH
                                            NOW</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade {{$own_or_not == 1  ? 'in active' : ''}}" id="hotel-reviews">
                        <div class="intro table-wrapper full-width hidden-table-sms">
                            <div class="rating table-cell col-sm-4">
                                ...
                                @else
                                <a href="{{ route('login') }}" class="button green btn-small full-width">WRITE A REVIEW</a>
                                @endauth
                            </div>
                    ...
                    <div class="write tab-pane fade" id="hotel-write-review">
                        ...
                        <form action="{{route('review', $res->first()->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="reviewed_by" name="reviewed_by" type="text" value="">
                                            ...
                                            <ul class="clearfix">
                                                ...
                                                <li class="col-md-6">
                                                    ...
                                                    <div class="each-rating">
                                                        ...
                                                        <input class="rating" max="5" name="review[]" oninput="this.style.setProperty('--value', `${this.valueAsNumber}`)" step="0.5" style="--value:{{ number_format($value, 1) }}" type="range" value="{{ number_format($value, 1) }}">
                                                        <!-- </label> -->
                                                        <!-- </div> -->
                                                        <!-- <div class="rating">
        ...
        <div class="sidebar col-md-3">
            <article class="detailed-logo">
                ...
                <div class="details">
                    <h2 class="box-title">{{ $res->first()->name }}<small><i class="soap-icon-departure yellow-color"></i><span class="fourty-space">Bastille, Paris france</span></small></h2>
